            ...
            <div class="row">
                ...
                <div class="col w-50 z-0 position-absolute bg-white align-self-end ps-5 pb-5 contact-us_bannerTxt">
                    <p class="mt-5 mb-4 font text-dark-emphasis fw-semibold">WE PRIDE OURSELVES IN PROVIDING EXCELLENT
                        SERVICE</p>
                    <h1 class="text-black display-3 fw-bold font_heading_banner m-0 pt-4 pb-4 text-uppercase">Diesel Pump
                        Laboratory</h1>
                </div>
            </div>
        </div>
            ...
            <div class="row pt-4">
                <div class="col-md-6 p-0">
                    <h1 class="text-black display-5 fw-bold font_heading text-uppercase"
                        style="font-weight: 700 !important;">Pumps, Injectors, Nozzles - Sales &amp; Repair</h1>
                </div>
            ...
            <div class="row mb-5">
                <div class="col">
                    <p class="font mt-5" style="color: #777777; font-size: 16px!important;text-align:justify;">
                        In the realm of diesel engines, the efficiency and performance of fuel injection
                        systems are paramount. At Saudi Industrial, our Fuel Injection Pumps Sales &amp;
                        Repair division is dedicated to ensuring that your diesel engines operate at their
                        peak. With a deep understanding of the critical nature of fuel injection
                        technology, we offer specialized sales and repair services for all types and
                        brands of diesel fuel injection pumps, including the latest electronic models.
                    </p>
                </div>
            </div>
        </div>
